...
namespace LibGit2Sharp.Core
{
    public static class NativeMethods
    {
        ...
        /// <summary>
        /// public hack to ensure that the call to git_threads_shutdown is called after all handle finalizers
        ...
        [DllImport(libgit2)]
        public static extern void giterr_set_str(
        ...
        [DllImport(libgit2)]
        public static extern UInt32 git_blame_get_hunk_count(BlameSafeHandle blame);

        [DllImport(libgit2)]
        public static extern IntPtr git_blame_get_hunk_byindex(
            BlameSafeHandle blame, UInt32 index);

        [DllImport(libgit2)]
        public static extern int git_blame_file(
        ...
        [DllImport(libgit2)]
        public static extern void git_blame_free(IntPtr blame);
        ...
        [DllImport(libgit2)]
        public static extern int git_blob_create_fromworkdir(
            ref GitOid id,
            RepositorySafeHandle repo,
        ...
        public delegate int source_callback(
            IntPtr content,
            int max_length,
            IntPtr data);
        ...
        [DllImport(libgit2)]
        public static extern int git_blob_filtered_content(
            GitBuf buf,
        ...
        [DllImport(libgit2)]
        public static extern Int64 git_blob_rawsize(GitObjectSafeHandle blob);
        ...
        public delegate int branch_foreach_callback(
            IntPtr branch_name,
            GitBranchType branch_type,
            IntPtr payload);

        [DllImport(libgit2)]
        public static extern void git_branch_iterator_free(
            IntPtr iterator);

        [DllImport(libgit2)]
        public static extern int git_branch_iterator_new(
        ...
        [DllImport(libgit2)]
        public static extern int git_branch_next(
            out ReferenceSafeHandle ref_out,
            out GitBranchType type_out,
            BranchIteratorSafeHandle iter);

        [DllImport(libgit2)]
        public static extern int git_branch_remote_name(
            GitBuf buf,
            RepositorySafeHandle repo,
        ...
        public delegate int git_remote_rename_problem_cb(
        ...
        [DllImport(libgit2)]
        public static extern int git_branch_upstream_name(
            GitBuf buf,
            RepositorySafeHandle repo,
        ...
        [DllImport(libgit2)]
        public static extern void git_buf_free(GitBuf buf);
        ...
        [DllImport(libgit2)]
        public static extern int git_clone(
        ...
        [DllImport(libgit2)]
        public static extern int git_commit_create_from_ids(
            out GitOid id,
            RepositorySafeHandle repo,
        ...
        [DllImport(libgit2)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(LaxUtf8NoCleanupMarshaler))]
        public static extern string git_commit_summary(GitObjectSafeHandle commit);
        ...
        [DllImport(libgit2)]
        public static extern OidSafeHandle git_commit_parent_id(GitObjectSafeHandle commit, uint n);

        [DllImport(libgit2)]
        public static extern uint git_commit_parentcount(GitObjectSafeHandle commit);

        [DllImport(libgit2)]
        public static extern OidSafeHandle git_commit_tree_id(GitObjectSafeHandle commit);

        [DllImport(libgit2)]
        public static extern int git_config_delete_entry(ConfigurationSafeHandle cfg, string name);

        [DllImport(libgit2)]
        public static extern int git_config_find_global(GitBuf global_config_path);

        [DllImport(libgit2)]
        public static extern int git_config_find_system(GitBuf system_config_path);

        [DllImport(libgit2)]
        public static extern int git_config_find_xdg(GitBuf xdg_config_path);

        [DllImport(libgit2)]
        public static extern void git_config_free(IntPtr cfg);

        [DllImport(libgit2)]
        public static extern void git_config_entry_free(IntPtr entry);

        [DllImport(libgit2)]
        public static extern int git_config_get_entry(
        ...
        [DllImport(libgit2)]
        public static extern int git_config_open_level(
        ...
        public delegate int config_foreach_callback(
            IntPtr entry,
            IntPtr payload);

        [DllImport(libgit2)]
        public static extern int git_config_foreach(
            ConfigurationSafeHandle cfg,
        ...
        [DllImport(libgit2)]
        public static extern int git_config_snapshot(out ConfigurationSafeHandle @out, ConfigurationSafeHandle config);
        ...
        public delegate int git_cred_acquire_cb(
            out IntPtr cred,
            IntPtr url,
        ...
        [DllImport(libgit2)]
        public static extern int git_cred_default_new(out IntPtr cred);

        [DllImport(libgit2)]
        public static extern int git_cred_userpass_plaintext_new(
            out IntPtr cred,
        ...
        [DllImport(libgit2)]
        public static extern int git_diff_tree_to_index(
            out DiffSafeHandle diff,
            RepositorySafeHandle repo,
            GitObjectSafeHandle oldTree,
        ...
        [DllImport(libgit2)]
        public static extern int git_diff_index_to_workdir(
            out DiffSafeHandle diff,
            RepositorySafeHandle repo,
            IndexSafeHandle index,
            GitDiffOptions options);
        ...
        [DllImport(libgit2)]
        public static extern int git_diff_tree_to_workdir(
            out DiffSafeHandle diff,
            RepositorySafeHandle repo,
            GitObjectSafeHandle oldTree,
            GitDiffOptions options);

        public delegate int git_diff_file_cb(
            [In] GitDiffDelta delta,
            float progress,
            IntPtr payload);

        public delegate int git_diff_hunk_cb(
            [In] GitDiffDelta delta,
            [In] GitDiffHunk hunk,
            IntPtr payload);

        public delegate int git_diff_line_cb(
            [In] GitDiffDelta delta,
            [In] GitDiffHunk hunk,
            [In] GitDiffLine line,
            IntPtr payload);
        ...
        [DllImport(libgit2)]
        public static extern int git_diff_find_similar(
            DiffSafeHandle diff,
            GitDiffFindOptions options);

        [DllImport(libgit2)]
        public static extern UIntPtr git_diff_num_deltas(DiffSafeHandle diff);

        [DllImport(libgit2)]
        public static extern IntPtr git_diff_get_delta(DiffSafeHandle diff, UIntPtr idx);

        [DllImport(libgit2)]
        public static extern int git_libgit2_features();

        [DllImport(libgit2)]
        public static extern int git_graph_ahead_behind(out UIntPtr ahead, out UIntPtr behind, RepositorySafeHandle repo, ref GitOid one, ref GitOid two);

        [DllImport(libgit2)]
        public static extern int git_graph_descendant_of(
            RepositorySafeHandle repo,
            ref GitOid commit,
            ref GitOid ancestor);
        ...
        [DllImport(libgit2)]
        public static extern int git_index_add_bypath(
            IndexSafeHandle index,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictFilePathMarshaler))] FilePath path);
        ...
        [DllImport(libgit2)]
        public static extern int git_index_conflict_get(
        ...
        [DllImport(libgit2)]
        public static extern UIntPtr git_index_entrycount(IndexSafeHandle index);

        [DllImport(libgit2)]
        public static extern int git_index_entry_stage(IndexEntrySafeHandle indexentry);

        [DllImport(libgit2)]
        public static extern void git_index_free(IntPtr index);

        [DllImport(libgit2)]
        public static extern IndexEntrySafeHandle git_index_get_byindex(IndexSafeHandle index, UIntPtr n);

        [DllImport(libgit2)]
        public static extern IndexEntrySafeHandle git_index_get_bypath(
            IndexSafeHandle index,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictFilePathMarshaler))] FilePath path,
            int stage);

        [DllImport(libgit2)]
        public static extern int git_index_has_conflicts(IndexSafeHandle index);

        [DllImport(libgit2)]
        public static extern uint git_index_name_entrycount(IndexSafeHandle handle);

        [DllImport(libgit2)]
        public static extern IndexNameEntrySafeHandle git_index_name_get_byindex(IndexSafeHandle handle, UIntPtr n);
        ...
        [DllImport(libgit2)]
        public static extern int git_index_read(
            IndexSafeHandle index,
            [MarshalAs(UnmanagedType.Bool)] bool force);

        [DllImport(libgit2)]
        public static extern int git_index_remove_bypath(
            IndexSafeHandle index,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictFilePathMarshaler))] FilePath path);


        [DllImport(libgit2)]
        public static extern uint git_index_reuc_entrycount(IndexSafeHandle handle);

        [DllImport(libgit2)]
        public static extern IndexReucEntrySafeHandle git_index_reuc_get_byindex(IndexSafeHandle handle, UIntPtr n);

        [DllImport(libgit2)]
        public static extern IndexReucEntrySafeHandle git_index_reuc_get_bypath(
        ...
        [DllImport(libgit2)]
        public static extern int git_index_write_tree(out GitOid treeOid, IndexSafeHandle index);

        [DllImport(libgit2)]
        public static extern int git_index_read_tree(IndexSafeHandle index, GitObjectSafeHandle tree);

        [DllImport(libgit2)]
        public static extern int git_index_clear(IndexSafeHandle index);

        [DllImport(libgit2)]
        public static extern int git_merge_base_many(
        ...
        [DllImport(libgit2)]
        public static extern int git_merge_base_octopus(
            out GitOid mergeBase,
            RepositorySafeHandle repo,
            int length,
            [In] GitOid[] input_array);
        ...
        [DllImport(libgit2)]
        public static extern int git_annotated_commit_from_ref(
            out GitAnnotatedCommitHandle annotatedCommit,
            RepositorySafeHandle repo,
            ReferenceSafeHandle reference);

        [DllImport(libgit2)]
        public static extern int git_annotated_commit_from_fetchhead(
            out GitAnnotatedCommitHandle annotatedCommit,
            RepositorySafeHandle repo,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string branch_name,
        ...
        [DllImport(libgit2)]
        public static extern int git_annotated_commit_lookup(
            out GitAnnotatedCommitHandle annotatedCommit,
            RepositorySafeHandle repo,
            ref GitOid id);

        [DllImport(libgit2)]
        public static extern OidSafeHandle git_annotated_commit_id(
            GitAnnotatedCommitHandle annotatedCommit);

        [DllImport(libgit2)]
        public static extern int git_merge(
            RepositorySafeHandle repo,
        ...
        [DllImport(libgit2)]
        public static extern int git_merge_trees(
            out IndexSafeHandle index,
            RepositorySafeHandle repo,
        ...
        [DllImport(libgit2)]
        public static extern int git_merge_analysis(
        ...
        [DllImport(libgit2)]
        public static extern void git_annotated_commit_free(
            IntPtr merge_head);
        ...
        [DllImport(libgit2)]
        public static extern OidSafeHandle git_note_id(NoteSafeHandle note);
        ...
        public delegate int git_note_foreach_cb(
            ref GitOid blob_id,
        ...
        [DllImport(libgit2)]
        public static extern int git_odb_add_backend(ObjectDatabaseSafeHandle odb, IntPtr backend, int priority);

        [DllImport(libgit2)]
        public static extern IntPtr git_odb_backend_malloc(IntPtr backend, UIntPtr len);

        [DllImport(libgit2)]
        public static extern int git_odb_exists(ObjectDatabaseSafeHandle odb, ref GitOid id);

        public delegate int git_odb_foreach_cb(
            IntPtr id,
            IntPtr payload);

        [DllImport(libgit2)]
        public static extern int git_odb_foreach(
            ObjectDatabaseSafeHandle odb,
            git_odb_foreach_cb cb,
            IntPtr payload);

        [DllImport(libgit2)]
        public static extern int git_odb_open_wstream(out OdbStreamSafeHandle stream, ObjectDatabaseSafeHandle odb, UIntPtr size, GitObjectType type);

        [DllImport(libgit2)]
        public static extern void git_odb_free(IntPtr odb);

        [DllImport(libgit2)]
        public static extern int git_odb_read_header(out UIntPtr len_out, out GitObjectType type, ObjectDatabaseSafeHandle odb, ref GitOid id);

        [DllImport(libgit2)]
        public static extern void git_object_free(IntPtr obj);

        [DllImport(libgit2)]
        public static extern int git_odb_stream_write(OdbStreamSafeHandle Stream, IntPtr Buffer, UIntPtr len);

        [DllImport(libgit2)]
        public static extern int git_odb_stream_finalize_write(out GitOid id, OdbStreamSafeHandle stream);

        [DllImport(libgit2)]
        public static extern void git_odb_stream_free(IntPtr stream);
        ...
        [DllImport(libgit2)]
        public static extern int git_object_peel(
            out GitObjectSafeHandle peeled,
            GitObjectSafeHandle obj,
            GitObjectType type);

        [DllImport(libgit2)]
        public static extern int git_object_short_id(
            GitBuf buf,
            GitObjectSafeHandle obj);
        ...
        [DllImport(libgit2)]
        public static extern int git_patch_from_diff(out PatchSafeHandle patch, DiffSafeHandle diff, UIntPtr idx);

        [DllImport(libgit2)]
        public static extern int git_patch_print(PatchSafeHandle patch, git_diff_line_cb print_cb, IntPtr payload);

        [DllImport(libgit2)]
        public static extern int git_patch_line_stats(
        ...
        public delegate int git_push_transfer_progress(uint current, uint total, UIntPtr bytes, IntPtr payload);
        public delegate int git_packbuilder_progress(int stage, uint current, uint total, IntPtr payload);

        [DllImport(libgit2)]
        public static extern int git_reference_create(
        ...
        [DllImport(libgit2)]
        public static extern int git_reference_symbolic_create(
            out ReferenceSafeHandle reference,
            RepositorySafeHandle repo,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string name,
        ...
        public delegate int ref_glob_callback(
        ...
        [DllImport(libgit2)]
        public static extern int git_reference_is_valid_name(
        ...
        [DllImport(libgit2)]
        public static extern int git_reference_list(out GitStrArray array, RepositorySafeHandle repo);
        ...
        [DllImport(libgit2)]
        public static extern int git_reference_remove(
            RepositorySafeHandle repo,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string name);

        [DllImport(libgit2)]
        public static extern OidSafeHandle git_reference_target(ReferenceSafeHandle reference);
        ...
        [DllImport(libgit2)]
        public static extern int git_reference_symbolic_set_target(
            out ReferenceSafeHandle ref_out,
            ReferenceSafeHandle reference,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string target,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string log_message);
        ...
        [DllImport(libgit2)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(LaxUtf8NoCleanupMarshaler))]
        public static extern string git_reference_symbolic_target(ReferenceSafeHandle reference);

        [DllImport(libgit2)]
        public static extern GitReferenceType git_reference_type(ReferenceSafeHandle reference);

        [DllImport(libgit2)]
        public static extern int git_reference_ensure_log(
            RepositorySafeHandle repo,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof (StrictUtf8Marshaler))] string refname);

        [DllImport(libgit2)]
        public static extern void git_reflog_free(
            IntPtr reflog);

        [DllImport(libgit2)]
        public static extern int git_reflog_read(
            out ReflogSafeHandle ref_out,
            RepositorySafeHandle repo,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string name);

        [DllImport(libgit2)]
        public static extern UIntPtr git_reflog_entrycount
            (ReflogSafeHandle reflog);

        [DllImport(libgit2)]
        public static extern ReflogEntrySafeHandle git_reflog_entry_byindex(
            ReflogSafeHandle reflog,
            UIntPtr idx);

        [DllImport(libgit2)]
        public static extern OidSafeHandle git_reflog_entry_id_old(
            SafeHandle entry);

        [DllImport(libgit2)]
        public static extern OidSafeHandle git_reflog_entry_id_new(
            SafeHandle entry);

        [DllImport(libgit2)]
        public static extern IntPtr git_reflog_entry_committer(
            SafeHandle entry);

        [DllImport(libgit2)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(LaxUtf8NoCleanupMarshaler))]
        public static extern string git_reflog_entry_message(SafeHandle entry);

        [DllImport(libgit2)]
        public static extern int git_refspec_rtransform(
            GitBuf buf,
        ...
        [DllImport(libgit2)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(LaxUtf8NoCleanupMarshaler))]
        public static extern string git_refspec_string(
            GitRefSpecHandle refSpec);

        [DllImport(libgit2)]
        public static extern RefSpecDirection git_refspec_direction(GitRefSpecHandle refSpec);

        [DllImport(libgit2)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(LaxUtf8NoCleanupMarshaler))]
        public static extern string git_refspec_dst(
            GitRefSpecHandle refSpec);

        [DllImport(libgit2)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(LaxUtf8NoCleanupMarshaler))]
        public static extern string git_refspec_src(
            GitRefSpecHandle refSpec);

        [DllImport(libgit2)]
        public static extern bool git_refspec_force(GitRefSpecHandle refSpec);

        [DllImport(libgit2)]
        public static extern int git_remote_autotag(RemoteSafeHandle remote);
        ...
        [DllImport(libgit2)]
        public static extern int git_remote_delete(
            RepositorySafeHandle repo,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string name);
        ...
        [DllImport(libgit2)]
        public static extern int git_remote_get_fetch_refspecs(out GitStrArray array, RemoteSafeHandle remote);

        [DllImport(libgit2)]
        public static extern GitRefSpecHandle git_remote_get_refspec(RemoteSafeHandle remote, UIntPtr n);

        [DllImport(libgit2)]
        public static extern int git_remote_get_push_refspecs(out GitStrArray array, RemoteSafeHandle remote);

        [DllImport(libgit2)]
        public static extern int git_remote_push(
            RemoteSafeHandle remote,
            ref GitStrArray refSpecs,
            GitPushOptions opts);

        [DllImport(libgit2)]
        public static extern UIntPtr git_remote_refspec_count(RemoteSafeHandle remote);

        [DllImport(libgit2)]
        public static extern int git_remote_set_fetch_refspecs(RemoteSafeHandle remote, ref GitStrArray array);

        [DllImport(libgit2)]
        public static extern int git_remote_set_push_refspecs(RemoteSafeHandle remote, ref GitStrArray array);

        [DllImport(libgit2)]
        public static extern int git_remote_set_url(
            RemoteSafeHandle remote,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string url);

        [DllImport(libgit2)]
        public static extern int git_remote_set_pushurl(
            RemoteSafeHandle remote,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string url);

        [DllImport(libgit2)]
        public static extern int git_remote_is_valid_name(
        ...
        [DllImport(libgit2)]
        public static extern int git_remote_list(out GitStrArray array, RepositorySafeHandle repo);

        [DllImport(libgit2)]
        public static extern int git_remote_lookup(
            out RemoteSafeHandle remote,
            RepositorySafeHandle repo,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string name);

        public delegate int git_headlist_cb(ref GitRemoteHead remoteHeadPtr, IntPtr payload);

        [DllImport(libgit2)]
        public static extern int git_remote_ls(out IntPtr heads, out UIntPtr size, RemoteSafeHandle remote);
        ...
        [DllImport(libgit2)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(LaxUtf8NoCleanupMarshaler))]
        public static extern string git_remote_pushurl(RemoteSafeHandle remote);

        [DllImport(libgit2)]
        public static extern void git_remote_set_autotag(RemoteSafeHandle remote, TagFetchMode option);

        [DllImport(libgit2)]
        public static extern int git_remote_set_callbacks(
            RemoteSafeHandle remote,
            ref GitRemoteCallbacks callbacks);

        public delegate int remote_progress_callback(IntPtr str, int len, IntPtr data);

        public delegate int remote_completion_callback(RemoteCompletionType type, IntPtr data);

        public delegate int remote_update_tips_callback(
            IntPtr refName,
            ref GitOid oldId,
            ref GitOid newId,
            IntPtr data);
        ...
        [DllImport(libgit2)]
        public static extern int git_repository_head_unborn(RepositorySafeHandle repo);

        [DllImport(libgit2)]
        public static extern int git_repository_ident(
        ...
        [DllImport(libgit2)]
        public static extern int git_repository_is_shallow(RepositorySafeHandle repo);

        [DllImport(libgit2)]
        public static extern int git_repository_state_cleanup(RepositorySafeHandle repo);

        public delegate int git_repository_mergehead_foreach_cb(
            ref GitOid oid,
            IntPtr payload);
        ...
        [DllImport(libgit2)]
        public static extern int git_repository_message(
            GitBuf buf,
        ...
        [DllImport(libgit2)]
        public static extern int git_repository_set_ident(
            RepositorySafeHandle repo,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string name,
        ...
        [DllImport(libgit2)]
        public static extern int git_repository_state(
            RepositorySafeHandle repository);
        ...
        [DllImport(libgit2)]
        public static extern int git_reset(
            RepositorySafeHandle repo,
        ...
        [DllImport(libgit2)]
        public static extern int git_revert(
            RepositorySafeHandle repo,
            GitObjectSafeHandle commit,
            GitRevertOpts opts);

        [DllImport(libgit2)]
        public static extern int git_revparse_ext(
        ...
        [DllImport(libgit2)]
        public static extern int git_revwalk_hide(RevWalkerSafeHandle walker, ref GitOid commit_id);

        [DllImport(libgit2)]
        public static extern int git_revwalk_new(out RevWalkerSafeHandle walker, RepositorySafeHandle repo);

        [DllImport(libgit2)]
        public static extern int git_revwalk_next(out GitOid id, RevWalkerSafeHandle walker);

        [DllImport(libgit2)]
        public static extern int git_revwalk_push(RevWalkerSafeHandle walker, ref GitOid id);

        [DllImport(libgit2)]
        public static extern void git_revwalk_reset(RevWalkerSafeHandle walker);

        [DllImport(libgit2)]
        public static extern void git_revwalk_sorting(RevWalkerSafeHandle walk, CommitSortStrategies sort);

        [DllImport(libgit2)]
        public static extern void git_revwalk_simplify_first_parent(RevWalkerSafeHandle walk);
        ...
        [DllImport(libgit2)]
        public static extern int git_signature_dup(out IntPtr dest, IntPtr sig);

        [DllImport(libgit2)]
        public static extern int git_stash_save(
            out GitOid id,
            RepositorySafeHandle repo,
        ...
        public delegate int git_stash_cb(
            UIntPtr index,
            IntPtr message,
            ref GitOid stash_id,
            IntPtr payload);
        ...
        [DllImport(libgit2)]
        public static extern int git_stash_foreach(
            RepositorySafeHandle repo,
            git_stash_cb callback,
            IntPtr payload);

        [DllImport(libgit2)]
        public static extern int git_stash_drop(RepositorySafeHandle repo, UIntPtr index);
        ...
        [DllImport(libgit2)]
        public static extern int git_status_list_new(
            out StatusListSafeHandle git_status_list,
            RepositorySafeHandle repo,
            GitStatusOptions options);

        [DllImport(libgit2)]
        public static extern int git_status_list_entrycount(
            StatusListSafeHandle statusList);

        [DllImport(libgit2)]
        public static extern StatusEntrySafeHandle git_status_byindex(
            StatusListSafeHandle list,
            UIntPtr idx);

        [DllImport(libgit2)]
        public static extern void git_status_list_free(
            IntPtr statusList);

        [DllImport(libgit2)]
        public static extern void git_strarray_free(
            ref GitStrArray array);

        [DllImport(libgit2)]
        public static extern int git_submodule_lookup(
        ...
        [DllImport(libgit2)]
        public static extern int git_submodule_update(
            SubmoduleSafeHandle sm,
            [MarshalAs(UnmanagedType.Bool)] bool init,
            ref GitSubmoduleOptions submoduleUpdateOptions);

        public delegate int submodule_callback(
            IntPtr sm,
            IntPtr name,
            IntPtr payload);

        [DllImport(libgit2)]
        public static extern int git_submodule_foreach(
            RepositorySafeHandle repo,
            submodule_callback callback,
            IntPtr payload);

        [DllImport(libgit2)]
        public static extern int git_submodule_add_to_index(
            SubmoduleSafeHandle submodule,
            [MarshalAs(UnmanagedType.Bool)] bool write_index);

        [DllImport(libgit2)]
        public static extern int git_submodule_save(
            SubmoduleSafeHandle submodule);

        [DllImport(libgit2)]
        public static extern void git_submodule_free(
            IntPtr submodule);

        [DllImport(libgit2)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(LaxUtf8NoCleanupMarshaler))]
        public static extern string git_submodule_path(
            SubmoduleSafeHandle submodule);

        [DllImport(libgit2)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(LaxUtf8NoCleanupMarshaler))]
        public static extern string git_submodule_url(
            SubmoduleSafeHandle submodule);

        [DllImport(libgit2)]
        public static extern OidSafeHandle git_submodule_index_id(
            SubmoduleSafeHandle submodule);

        [DllImport(libgit2)]
        public static extern OidSafeHandle git_submodule_head_id(
            SubmoduleSafeHandle submodule);

        [DllImport(libgit2)]
        public static extern OidSafeHandle git_submodule_wd_id(
            SubmoduleSafeHandle submodule);

        [DllImport(libgit2)]
        public static extern SubmoduleIgnore git_submodule_ignore(
            SubmoduleSafeHandle submodule);

        [DllImport(libgit2)]
        public static extern SubmoduleUpdate git_submodule_update_strategy(
            SubmoduleSafeHandle submodule);

        [DllImport(libgit2)]
        public static extern SubmoduleRecurse git_submodule_fetch_recurse_submodules(
            SubmoduleSafeHandle submodule);

        [DllImport(libgit2)]
        public static extern int git_submodule_reload(
            SubmoduleSafeHandle submodule,
            [MarshalAs(UnmanagedType.Bool)] bool force);

        [DllImport(libgit2)]
        public static extern int git_submodule_status(
            out SubmoduleStatus status,
            SubmoduleSafeHandle submodule);

        [DllImport(libgit2)]
        public static extern int git_submodule_init(
            SubmoduleSafeHandle submodule,
        ...
        [DllImport(libgit2)]
        public static extern int git_tag_list(out GitStrArray array, RepositorySafeHandle repo);
        ...
        [DllImport(libgit2)]
        public static extern OidSafeHandle git_tag_target_id(GitObjectSafeHandle tag);

        [DllImport(libgit2)]
        public static extern GitObjectType git_tag_target_type(GitObjectSafeHandle tag);
        ...
        [DllImport(libgit2)]
        public static extern int git_openssl_set_locking();

        public delegate void git_trace_cb(LogLevel level, IntPtr message);

        [DllImport(libgit2)]
        public static extern int git_trace_set(LogLevel level, git_trace_cb trace_cb);

        public delegate int git_transfer_progress_callback(ref GitTransferProgress stats, IntPtr payload);

        public delegate int git_transport_cb(out IntPtr transport, IntPtr remote, IntPtr payload);

        [DllImport(libgit2)]
        public static extern int git_transport_register(
        ...
        [DllImport(libgit2)]
        public static extern int git_transport_smart(
            out IntPtr transport,
            IntPtr remote,
            IntPtr definition);

        [DllImport(libgit2)]
        public static extern int git_transport_unregister(
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalCookie = UniqueId.UniqueIdentifier, MarshalTypeRef = typeof(StrictUtf8Marshaler))] string prefix);
        ...
        [DllImport(libgit2)]
        public static extern TreeEntrySafeHandle git_tree_entry_byindex(GitObjectSafeHandle tree, UIntPtr idx);
        ...
        [DllImport(libgit2)]
        public static extern UIntPtr git_tree_entrycount(GitObjectSafeHandle tree);

        [DllImport(libgit2)]
        public static extern int git_treebuilder_new(out TreeBuilderSafeHandle builder, RepositorySafeHandle repo, IntPtr src);
        ...
        [DllImport(libgit2)]
        public static extern int git_treebuilder_write(out GitOid id, TreeBuilderSafeHandle bld);

        [DllImport(libgit2)]
        public static extern void git_treebuilder_free(IntPtr bld);

        [DllImport(libgit2)]
        public static extern int git_blob_is_binary(GitObjectSafeHandle blob);

        [DllImport(libgit2)]
        public static extern int git_cherrypick(RepositorySafeHandle repo, GitObjectSafeHandle commit, GitCherryPickOptions options);
    }
}
